...
class APITest(NotebookTestBase):
    ...
    def test_mkdir_untitled(self):
        ...
        self._check_created(resp, u'å b/app', type='directory')

        # Second time
        resp = self.api.mkdir_untitled(path=u'å b')
        self._check_created(resp, u'å b/app 1', type='directory')

        # And two directories down
        resp = self.api.mkdir_untitled(path='foo/bar')
        self._check_created(resp, 'foo/bar/app', type='directory')
